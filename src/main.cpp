...
//---genesis blocks -------------------------------------------------------------------------------------
uint256 hashGenesisBlock("0x002dba2a9a853645ebef488858e03d6050dc67c9007555dfebac69c6ae27eeaf");
uint256 hashGenesisBlockTestNet("0x00183b00dd048d39ff2a670667f6a724b64f11e7b4c1ece98ec02e15be215b2c");
//-------------------------------------------------------------------------------------------------------
uint256 MainHashMerkleRoot("0x9bfb4b705c5a2313ff0f5a24331db3b7c89406f3c3b84e4483ce472904c938d7");
//--time blocks ---------------------------------------
static const unsigned int timeGenesisBlock =1449491267;
static const unsigned int timeGenesisBlockTestNet =1449491285;
//-------nNonce -------------------------------------
static const unsigned int nNonceGenesis=865;
static const unsigned int nNonceGenesisTestNet=1933;
//----------------------------------------------------
...
const string strMessageMagic = "Argon2 Signed Message:\n";
...
static const int64 nPremine = 100000 * COIN;
int64 minimumSubsidy = 2.0 * COIN;
...
static const int64 nTargetSpacing = 1 * 60; // Argon2 every 60 seconds
...
bool CBlock::AcceptBlock(CValidationState &state, CDiskBlockPos *dbp)
{
    ...
    if (hash != hashGenesisBlock) {
        ...
        // Prevent blocks from too far in the future [since Argon2 version 2.0 at block 100,000]
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "How to overclock a CPU: Get more from your Intel or AMD processor";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 482304888 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("06438afdb0fe5548271967f1a67130b4795cd6a828e03909a25362e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c211df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
        CBlock block;
...
unsigned char pchMessageStart[4] = { 0xbe, 0xf9, 0xb4, 0xd5 };
        ...
        BOOST_FOREACH(CAddress& addr, vAddr)
        {
            ...
            if (addr.nTime > nSince && !pfrom->fGetAddr && vAddr.size() <= 10 && addr.IsRoutable())
            {
                // Relay to a limited number of other nodes
                {
                    ...
                    hashRand = hashArgon2(BEGIN(hashRand), END(hashRand));
                    ...
                    BOOST_FOREACH(CNode* pnode, vNodes)
                    {
                        ...
                        hashKey = hashArgon2(BEGIN(hashKey), END(hashKey));
...
bool ProcessMessages(CNode* pfrom)
{
    ...
    while (!pfrom->fDisconnect && it != pfrom->vRecvMsg.end()) {
        ...
        uint256 hash = hashArgon2(vRecv.begin(), vRecv.begin() + nMessageSize);
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("Argon2Miner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("Argon2Miner : ProcessBlock, block not accepted");
    }
...
{
    printf("Argon2Miner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Argon2-miner");
    ...
    try { loop {
        ...
        printf("Running Argon2Miner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
